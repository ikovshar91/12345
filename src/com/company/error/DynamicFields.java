...
public class DynamicFields {
    ...
    public DynamicFields(int initialSize) {
        ...
        public String toString() {
            StringBuilder result = new StringBuilder(); for(Object[] obj : fields) {
                result.append(obj[0]);
                result.append(": ");
                result.append(obj[1]);
                result.append("\n");
    ...
    private int getFieldNumber(String id) throws NoSuchFieldException {
        ...
        private int makeField(String id) { for(int i = 0; i < fields.length; i++) if(fields[i][0] == null) {
            fields[i][0] = id;
            return i;
        }
...
// Рекурсивный вызов с новыми полями:
            ...
            public Object
            getField(String id) throws NoSuchFieldException { return fields[getFieldNumber(id)][1];
            }
            public Object setField(String id, Object value) throws DynamicFieldsException {
                if (value == null) {
// У большинства исключений нет конструктора,
// принимающего объект-причину.
// В таких случаях следует использовать // метод
// initCause(), доступный всем // подклассам Throwable.
                ...
                return result;
                    ...
                    public static void main(String[] args) throws NoSuchFieldException {
                        ...
                        try {
                            ...
                            Object field = df.setField("d", null); // Исключение } catch(NoSuchFieldException e) { e.printStackTrace(System.out);
